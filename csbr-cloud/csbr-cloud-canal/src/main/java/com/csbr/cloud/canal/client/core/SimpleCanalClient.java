package com.csbr.cloud.canal.client.core;

import com.alibaba.otter.canal.client.CanalConnector;
import com.csbr.cloud.canal.annotation.ListenPoint;
import com.csbr.cloud.canal.client.abstracts.AbstractCanalClient;
import com.csbr.cloud.canal.client.interfaces.CanalEventListener;
import com.csbr.cloud.canal.config.CanalConfig;
import com.csbr.cloud.canal.util.BeanUtil;
...
public class SimpleCanalClient extends AbstractCanalClient {
	...
	private void initListeners() {
		...
		//若是你喜欢通过注解的方式去监听的话。。
		Map<String, Object> listenerMap = BeanUtil.getBeansWithAnnotation(com.csbr.cloud.canal.annotation.CanalEventListener.class);
		//也放入 map
		if (listenerMap != null) {
